...
namespace Morello.Dungeons.Spells
{
    public class Spellbook
    {
        ...
        public Spellbook()
        {
            spellList = new List<Spell>
            {
                new Spell(
                    ...
                    SpellSchool.SpellSchoolEnum.Evocation,
                    "Instantaneous",
                    0,
                    "action",
                    1,
                    ...
                    new Classes.ClassList(new List<string>()
                    {
                        "Wizard",
                        "Sorcerer"
                    }),
        ...
        {
            return spellList.ElementAt(Calculator.GetRandomNumber(0, spellList.Count-1));
        }
    }
}
